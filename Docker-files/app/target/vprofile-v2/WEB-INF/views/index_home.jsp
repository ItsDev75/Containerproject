                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">Know Cloud</a>
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  <img style='opacity:.8' class="w3-image" src="${contextPath}/resources/Images/header.png" alt="Architecture" width="1500" height="800">
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">Know Cloud is an open-socurce DevOps Learning Group
	    </p>
	  
		<p><strong>E-Mail ID :</strong>  info@knowcloud.tech</p>
    <p><strong>Web :</strong> www.knowcloud.tech</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2023 <a href="#"  target="_blank" class="w3-hover-text-green"> knowcloud.tech</a></p>
</footer>
